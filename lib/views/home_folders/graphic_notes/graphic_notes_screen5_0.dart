...
class MyHomePage5_0 extends StatefulWidget {
  MyHomePage5_0({this.title});

  final String? title;

  @override
  _MyHomePage5_0State createState() => _MyHomePage5_0State();
}

class _MyHomePage5_0State extends State<MyHomePage5_0> {
            ...
            itemBuilder: (context, int index) {
              ...
              return imageList.map((e) {
                return
                    ...
                    //                       child:
                    Container(
                        margin: EdgeInsets.fromLTRB(0, 20 * leftSplitterWidth,
                            0, 20 * leftSplitterWidth),
                        ...
                        //       //     leftSplitterWidth,
                        //       // width:
                        //       //     MediaQuery.of(context).size.width * leftSplitterWidth,
                        //       color: Colors.red,
                        //       child: Transform.scale(
                        //         alignment: Alignment.topLeft,
                        //         scale: 2 * leftSplitterWidth,
                        //         // scale: leftSplitterWidth < 0.3
                        //         //     ? 1
                        //         //     : 2 * leftSplitterWidth,
                        //         child: e['image'],
                        //       ),
